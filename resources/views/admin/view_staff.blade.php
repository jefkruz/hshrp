                        ...
                        <div class="card-body table-responsive">
                            <table class="table datatable table-striped">
                                ...
                                @foreach($member_data['goals'] as $i => $goal)
                                    <tr>
                                        <td>{{$i + 1}}</td>
                                        <td><a href="{{route('director.viewGoal', $goal->id)}}">{{$goal->subject}}</a></td>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    <button data-toggle="modal" data-target="#appraisalModal" class="btn btn-purple btn-sm"><i class="fa fa-scroll"></i> Appraise Unit Head</button>
                                </div>
                                @endif
                                <div class="col-md-12">
                                    <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="card card-file">
                                                    <div class="dropdown-file">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a href="{{route('director.viewAppraisal', $app->id)}}" class="dropdown-item">View Details</a>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('director.submitAppraisal')}}">
                        @csrf

                        <input type="hidden" name="staff_id" value="{{$member_data['member']->id}}" required>
                        <input type="hidden" name="from_director" value="yes" required>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="">Director Comment</label>
