...
<head>
    ...
    <meta name="description" content="Personnel Management Integrated Systemn">
    <meta name="keywords" content="healing school,report,finance">
            ...
            <li class="nav-item dropdown has-arrow main-drop">
                <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                    ...
                    <span>{{session('admin')->name}}</span>
                        @else
                    <span>{{session('director')->title}} {{session('director')->firstname}} {{session('director')->lastname}}</span>
                    @endif
                </a>
